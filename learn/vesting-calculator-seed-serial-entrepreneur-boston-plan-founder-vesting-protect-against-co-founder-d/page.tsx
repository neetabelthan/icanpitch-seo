...
const jsonLdData = [
  {
    ...
    "datePublished": "2025-08-08T20:19:46.478Z",
    "url": "https://icanpitch.com/learn/vesting-calculator-seed-serial-entrepreneur-boston-plan-founder-vesting-protect-against-co-founder-d/"
  }
];
          ...
          <div className="container px-4 md:px-6"{'>'}
            <div className="mx-auto max-w-4xl text-center"{'>'}
              ...
              <div className="flex flex-wrap justify-center gap-2"{'>'}
                ...
                <Badge variant="secondary"{'>'}Boston</Badge{'>'}
              </div{'>'}
            </div{'>'}
          </div{'>'}
        </section{'>'}
          ...
          <div className="container px-4 md:px-6"{'>'}
            <div className="mx-auto max-w-4xl"{'>'}
              <div className="prose prose-gray max-w-none dark:prose-invert prose-lg"{'>'}
                <h2{'>'}What Our Vesting Calculator Does</h2{'>'}
                <p{'>'}</p>
                ...
                <h2{'>'}Why This Matters for Seed Serial Entrepreneur</h2{'>'}
                <p{'>'}</p>
                  At the seed stage, serial-entrepreneur face unique challenges that require specialized financial tools. 
                ...
                <h2{'>'}How to Protect-against-co-founder-departure with Vesting Calculator</h2{'>'}
                <p{'>'}Our calculator is specifically built to help you protect-against-co-founder-departure. The process is straightforward:</p{'>'}</p>
              ...
              <Card className="border-primary/20 shadow-lg"{'>'}
                ...
                <CardContent{'>'}
                  <Button size="lg" className="btn-primary text-lg px-8 py-4" asChild{'>'}
                    <a href="/tools/vesting-calculator/"{'>'}
                      Start Calculator →
                    </a{'>'}
                  </Button{'>'}
                </CardContent{'>'}
