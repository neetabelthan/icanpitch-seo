...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/gross-burn-vs-net-burn-rate-explained/",
  },
};
...
const jsonLdData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/gross-burn-vs-net-burn-rate-explained/"
    },
    "url": "https://icanpitch.com/blog/gross-burn-vs-net-burn-rate-explained/",
    "publisher": {
      "@type": "Organization",
...
export default function GrossBurnVsNetBurnRateExplainedBlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Gross Burn vs Net Burn Rate: Complete Guide for Founders" },
  ];
