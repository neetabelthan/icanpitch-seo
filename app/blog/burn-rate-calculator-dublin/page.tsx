...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Calculate your Dublin startup's burn rate with Irish labor costs, R&D tax credits, and Silicon Docks benchmarks. Compare to London and Berlin tech hubs.",
    type: "article",
    publishedTime: "2024-09-28T00:00:00.000Z",
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/burn-rate-calculator-dublin/",
  },
};
...
const jsonLdData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/burn-rate-calculator-dublin/"
    },
    "url": "https://icanpitch.com/blog/burn-rate-calculator-dublin/",
    "publisher": {
      "@type": "Organization",
...
export default function BurnRateCalculatorDublinBlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Dublin Burn Rate Calculator: Track Your Startup's Monthly Cash Flow in EUR" },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-gray-600 mb-8">
                ...
                <time dateTime="2024-09-28T00:00:00.000Z">September 27, 2024</time>
                <span>•</span>
