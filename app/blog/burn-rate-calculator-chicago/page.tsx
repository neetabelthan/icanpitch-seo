...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/burn-rate-calculator-chicago/",
  },
};
...
const jsonLdData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/burn-rate-calculator-chicago/"
    },
    "url": "https://icanpitch.com/blog/burn-rate-calculator-chicago/",
    "publisher": {
      "@type": "Organization",
...
export default function BurnRateCalculatorChicagoBlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Chicago Burn Rate Calculator: Track Startup Runway in the Midwest Tech Hub" },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-gray-600 mb-8">
                ...
                <time dateTime="2024-09-23T00:00:00.000Z">September 22, 2024</time>
                <span>•</span>
