...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/burn-rate-calculator-new-york-city-startup-costs/",
  },
};
...
const jsonLdData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/burn-rate-calculator-new-york-city-startup-costs/"
    },
    "url": "https://icanpitch.com/blog/burn-rate-calculator-new-york-city-startup-costs/",
    "publisher": {
      "@type": "Organization",
...
export default function BurnRateCalculatorNewYorkCityStartupCostsBlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Burn Rate Calculator for NYC Startups: New York Cost Guide 2025" },
  ];
