...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/seed-burn-rate-benchmarks-2025/",
  },
};
...
const jsonLdData = [
  {
    ...
    "dateModified": "2025-01-08T00:00:00.000Z",
    "author": {
      "@type": "Organization",
      "name": "ICanPitch"
    },
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/seed-burn-rate-benchmarks-2025/"
    },
    "url": "https://icanpitch.com/blog/seed-burn-rate-benchmarks-2025/",
    "publisher": {
      "@type": "Organization",
...
export default function SeedBurnRateBenchmarks2025BlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Seed Stage Burn Rate Benchmarks 2025: Scaling from Pre-Seed to PMF" },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-gray-600 mb-8">
                ...
                <time dateTime="2025-01-08T00:00:00.000Z">January 7, 2025</time>
                <span>•</span>
