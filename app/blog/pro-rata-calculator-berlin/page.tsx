...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.icanpitch.com/blog/pro-rata-calculator-berlin/",
  },
};
...
const jsonLdData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://learn.icanpitch.com/blog/pro-rata-calculator-berlin/"
    },
    "url": "https://icanpitch.com/blog/pro-rata-calculator-berlin/",
    "publisher": {
      "@type": "Organization",
...
export default function ProRataCalculatorBerlinBlogPost() {
  const breadcrumbItems = [
    ...
    { label: "Pro-Rata Rights Calculator for Berlin Startups (2025)" },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-gray-600 mb-8">
                ...
                <time dateTime="2024-11-12T00:00:00.000Z">November 11, 2024</time>
                <span>•</span>
