...
export const metadata: Metadata = {
  ...
  description: "Free equity split calculator for pre-seed serial-entrepreneur in London. Create-fair-equity-distribution with accurate modeling and real-time calculations. Used by 1000+ founders.",
  ...
  openGraph: {
    ...
    images: ["/og/equity-split-calculator-pre-seed-serial-entrepreneur-london-resolve-co-founder-disputes-create-fair-.png"],
  },
  twitter: {
...
export default function EquitySplitCalculatorPreSeedSerialEntrepreneurLondonResolveCoFounderDisputesCreateFairPage(): React.JSX.Element {
  return (
    <>
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto mb-8">
                Free equity split calculator for pre-seed serial-entrepreneur in London. Create-fair-equity-distribution with accurate modeling and real-time calculations. Used by 1000+ founders.
              </p>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg prose-gray max-w-none">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">What Our Equity Split Calculator Does</h2>
                <p className="text-gray-700 leading-relaxed">
                  Our Equity Split Calculator is specifically designed for pre-seed serial entrepreneur who need precise financial modeling.
                ...
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">Why This Matters for Pre Seed Serial Entrepreneur</h2>
                <p className="text-gray-700 leading-relaxed">
                  At the pre-seed stage, serial entrepreneurs face unique challenges that require specialized financial tools.
                  Traditional spreadsheets often fall short when modeling complex equity structures and conversion scenarios.
                  Our Equity Split Calculator addresses these specific needs with industry-standard calculations and professional-grade analysis.
                </p>
                ...
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">How to Create Fair Equity Distribution with Equity Split Calculator</h2>
                <p className="text-gray-700 leading-relaxed mb-6">Our calculator is specifically built to help you create fair equity distribution. The process is straightforward:</p>
