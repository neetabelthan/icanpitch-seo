          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg prose-gray max-w-none">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">What Our Safe Calculator Does</h2>
                ...
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">Why This Matters for Seed Technical Founder</h2>
                <p className="text-gray-700 leading-relaxed">
                  At the seed stage, technical founders face unique challenges that require specialized financial tools.
                ...
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">How to Maximize Founder Ownership with Safe Calculator</h2>
                <p className="text-gray-700 leading-relaxed mb-6">Our calculator is specifically built to help you maximize founder ownership. The process is straightforward:</p>
